...
export const Follow              = createEntity('follows',               { ownedByUser: false });
export const Friendship          = createEntity('friendships',           { ownedByUser: false });
...
export const UserProfile         = createEntity('user_profiles',         { ownedByUser: false });
